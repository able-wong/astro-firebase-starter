 ...
 *
 * This script uses Firebase Admin SDK to fetch data from collections.
 *
 ...
 *
 * Examples:
 * node scripts/firebase-data-fetcher.js users
 * node scripts/firebase-data-fetcher.js users --limit 5
 * node scripts/firebase-data-fetcher.js users --doc user-1
 * node scripts/firebase-data-fetcher.js users --all
 */
...
`);
  ...
  const options = { collection: args[0] };
